...
pageUrl = "https://83.push2.eastmoney.com/api/qt/clist/get?cb=jQuery1124021407173762726472_1723627676282&pz=20&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&dect=1&wbp2u=|0|0|0|web&fid=f3&fs=m:0+t:6,m:0+t:80&fields=f12,f14&_=1723627676292"
    ...
    for i in counter:
        ...
        for item in resp:
            try:
                ...
                # 捕捉并处理请求异常
                print(f"request stock daily error: {e}")
